...
#define RSC_TRACE_SZ (16*1024)
#endif /* RSC_TRACE_SZ */
static char rsc_trace_buf[RSC_TRACE_SZ] = "INIT_OK\n";
...
struct remote_resource_table __resource resources = {
	...
	.offset[2] = offsetof(struct remote_resource_table, rpu_ddr),
	/* Virtio device entry */
	.rpmsg_vdev = {
		.type =		RSC_VDEV,
		.id =		VIRTIO_ID_RPMSG_,
	...
	.rpu_ddr = {
	    ...
	    .flags    = 0,
	    .reserved = {0},
	    .name     = "rpu_ddr_buffer",  // 必须和设备树节点名字一致
	},
};
