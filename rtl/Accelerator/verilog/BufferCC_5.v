...
module BufferCC_5 (
  ...
  input  wire          clk,
  input  wire          SystolicArray2D_CC_core_reset_synchronized
);
  ...
  always @(posedge clk or posedge SystolicArray2D_CC_core_reset_synchronized) begin
    if(SystolicArray2D_CC_core_reset_synchronized) begin
      buffers_0 <= 7'h0;
      buffers_1 <= 7'h0;
    end else begin
      buffers_0 <= io_dataIn;
