...
// Component : SystolicArray2DUnitSpecial
// Git hash  : e7984c6fd05794f7617e004bdecebf29e04e3020

`timescale 1ns/1ps 
module SystolicArray2DUnitSpecial (
  ...
  output wire [1:0]    io_downStream_payload_Ctrl_Mode,
  output wire          io_downStream_payload_Ctrl_Transpose,
  output wire [5:0]    io_downStream_payload_Ctrl_Shift,
  output wire [3:0]    io_downStream_payload_ID,
  ...
  wire       [1:0]    upStream_for_downStream_payload_Ctrl_Mode;
  wire                upStream_for_downStream_payload_Ctrl_Transpose;
  wire       [5:0]    upStream_for_downStream_payload_Ctrl_Shift;
  wire       [3:0]    upStream_for_downStream_payload_ID;
  ...
  wire       [1:0]    upStream_for_downStream_s2mPipe_payload_Ctrl_Mode;
  wire                upStream_for_downStream_s2mPipe_payload_Ctrl_Transpose;
  wire       [5:0]    upStream_for_downStream_s2mPipe_payload_Ctrl_Shift;
  wire       [3:0]    upStream_for_downStream_s2mPipe_payload_ID;
  ...
  reg        [1:0]    upStream_for_downStream_rData_Ctrl_Mode;
  reg                 upStream_for_downStream_rData_Ctrl_Transpose;
  reg        [5:0]    upStream_for_downStream_rData_Ctrl_Shift;
  reg        [3:0]    upStream_for_downStream_rData_ID;
  wire       [1:0]    _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode;
  ...
  wire       [1:0]    upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode;
  wire                upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Transpose;
  wire       [5:0]    upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Shift;
  wire       [3:0]    upStream_for_downStream_s2mPipe_m2sPipe_payload_ID;
  ...
  reg        [1:0]    upStream_for_downStream_s2mPipe_rData_Ctrl_Mode;
  reg                 upStream_for_downStream_s2mPipe_rData_Ctrl_Transpose;
  reg        [5:0]    upStream_for_downStream_s2mPipe_rData_Ctrl_Shift;
  reg        [3:0]    upStream_for_downStream_s2mPipe_rData_ID;
  ...
  reg [79:0] io_downStream_payload_Ctrl_Mode_string;
  reg [79:0] io_result_payload_Ctrl_Mode_string;
  reg [79:0] upStream_for_downStream_payload_Ctrl_Mode_string;
  reg [79:0] upStream_for_result_payload_Ctrl_Mode_string;
  reg [79:0] upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string;
  reg [79:0] upStream_for_downStream_rData_Ctrl_Mode_string;
  reg [79:0] _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string;
  reg [79:0] upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode_string;
  reg [79:0] upStream_for_downStream_s2mPipe_rData_Ctrl_Mode_string;
  ...
  always @(*) begin
    case(io_downStream_payload_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : io_downStream_payload_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : io_downStream_payload_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : io_downStream_payload_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : io_downStream_payload_Ctrl_Mode_string = "ElementMax";
      default : io_downStream_payload_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
  ...
  always @(*) begin
    case(upStream_for_downStream_payload_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : upStream_for_downStream_payload_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : upStream_for_downStream_payload_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : upStream_for_downStream_payload_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : upStream_for_downStream_payload_Ctrl_Mode_string = "ElementMax";
      default : upStream_for_downStream_payload_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
  ...
  always @(*) begin
    case(upStream_for_downStream_s2mPipe_payload_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "ElementMax";
      default : upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
    case(upStream_for_downStream_rData_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : upStream_for_downStream_rData_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : upStream_for_downStream_rData_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : upStream_for_downStream_rData_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : upStream_for_downStream_rData_Ctrl_Mode_string = "ElementMax";
      default : upStream_for_downStream_rData_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
    case(_zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "ElementMax";
      default : _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
    case(upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode_string = "ElementMax";
      default : upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
    case(upStream_for_downStream_s2mPipe_rData_Ctrl_Mode)
      MatrixOperation_TypeDef_MatMul : upStream_for_downStream_s2mPipe_rData_Ctrl_Mode_string = "MatMul    ";
      MatrixOperation_TypeDef_ElementAdd : upStream_for_downStream_s2mPipe_rData_Ctrl_Mode_string = "ElementAdd";
      MatrixOperation_TypeDef_ElementMul : upStream_for_downStream_s2mPipe_rData_Ctrl_Mode_string = "ElementMul";
      MatrixOperation_TypeDef_ElementMax : upStream_for_downStream_s2mPipe_rData_Ctrl_Mode_string = "ElementMax";
      default : upStream_for_downStream_s2mPipe_rData_Ctrl_Mode_string = "??????????";
    endcase
  end
  always @(*) begin
  ...
  assign upStream_for_downStream_payload_Ctrl_Mode = io_upStream_payload_Ctrl_Mode;
  assign upStream_for_downStream_payload_Ctrl_Transpose = io_upStream_payload_Ctrl_Transpose;
  assign upStream_for_downStream_payload_Ctrl_Shift = io_upStream_payload_Ctrl_Shift;
  assign upStream_for_downStream_payload_ID = io_upStream_payload_ID;
  ...
  assign _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode = (upStream_for_downStream_rValidN ? upStream_for_downStream_payload_Ctrl_Mode : upStream_for_downStream_rData_Ctrl_Mode);
  ...
  assign upStream_for_downStream_s2mPipe_payload_Ctrl_Mode = _zz_upStream_for_downStream_s2mPipe_payload_Ctrl_Mode;
  assign upStream_for_downStream_s2mPipe_payload_Ctrl_Transpose = (upStream_for_downStream_rValidN ? upStream_for_downStream_payload_Ctrl_Transpose : upStream_for_downStream_rData_Ctrl_Transpose);
  assign upStream_for_downStream_s2mPipe_payload_Ctrl_Shift = (upStream_for_downStream_rValidN ? upStream_for_downStream_payload_Ctrl_Shift : upStream_for_downStream_rData_Ctrl_Shift);
  assign upStream_for_downStream_s2mPipe_payload_ID = (upStream_for_downStream_rValidN ? upStream_for_downStream_payload_ID : upStream_for_downStream_rData_ID);
  always @(*) begin
  ...
  assign upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode = upStream_for_downStream_s2mPipe_rData_Ctrl_Mode;
  assign upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Transpose = upStream_for_downStream_s2mPipe_rData_Ctrl_Transpose;
  assign upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Shift = upStream_for_downStream_s2mPipe_rData_Ctrl_Shift;
  assign upStream_for_downStream_s2mPipe_m2sPipe_payload_ID = upStream_for_downStream_s2mPipe_rData_ID;
  ...
  assign io_downStream_payload_Ctrl_Mode = upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Mode;
  assign io_downStream_payload_Ctrl_Transpose = upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Transpose;
  assign io_downStream_payload_Ctrl_Shift = upStream_for_downStream_s2mPipe_m2sPipe_payload_Ctrl_Shift;
  assign io_downStream_payload_ID = upStream_for_downStream_s2mPipe_m2sPipe_payload_ID;
  ...
  always @(posedge SystolicArray2D_CC_core_clk) begin
    if(upStream_for_downStream_ready) begin
      ...
      upStream_for_downStream_rData_Ctrl_Mode <= upStream_for_downStream_payload_Ctrl_Mode;
      upStream_for_downStream_rData_Ctrl_Transpose <= upStream_for_downStream_payload_Ctrl_Transpose;
      upStream_for_downStream_rData_Ctrl_Shift <= upStream_for_downStream_payload_Ctrl_Shift;
      upStream_for_downStream_rData_ID <= upStream_for_downStream_payload_ID;
    end
    if(upStream_for_downStream_s2mPipe_ready) begin
      ...
      upStream_for_downStream_s2mPipe_rData_Ctrl_Mode <= upStream_for_downStream_s2mPipe_payload_Ctrl_Mode;
      upStream_for_downStream_s2mPipe_rData_Ctrl_Transpose <= upStream_for_downStream_s2mPipe_payload_Ctrl_Transpose;
      upStream_for_downStream_s2mPipe_rData_Ctrl_Shift <= upStream_for_downStream_s2mPipe_payload_Ctrl_Shift;
      upStream_for_downStream_s2mPipe_rData_ID <= upStream_for_downStream_s2mPipe_payload_ID;
    end
