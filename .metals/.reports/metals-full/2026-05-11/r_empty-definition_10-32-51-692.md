error id: file://<WORKSPACE>/sw/java/main/java/org/forwarder/Forwarder.java:java/lang/RuntimeException#
...
public class Forwarder {
	...
	public static Model load(String onnxModelPath, Config config)
		...
		if (Forwarder.modelSet.putIfAbsent(modelId, model) == null)
			...
			throw new RuntimeExce@@ption(String.format("Model Id \"%s\" has existed in model set", modelId));
	}
