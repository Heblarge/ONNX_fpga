error id: file://<WORKSPACE>/sw/java/main/java/org/forwarder/Forwarder.java:_empty_/Model#
...
public class Forwarder {
	...
	private static final Map<String, Mode@@l> modelSet = new ConcurrentHashMap<String, Model>();
