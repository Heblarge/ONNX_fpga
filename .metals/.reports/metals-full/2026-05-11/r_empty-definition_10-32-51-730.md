error id: file://<WORKSPACE>/sw/java/main/java/org/forwarder/Forwarder.java:java/util/Collections#unmodifiableMap().
file://<WORKSPACE>/sw/java/main/java/org/forwarder/Forwarder.java
empty definition using pc, found symbol in pc: java/util/Collections#unmodifiableMap().
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 2393
uri: file://<WORKSPACE>/sw/java/main/java/org/forwarder/Forwarder.java
text:
```scala
/**
...
public class Forwarder {
	...
	public static Map<String, Model> getModelSet() {
		return Collections.unm@@odifiableMap(Forwarder.modelSet);
	}
