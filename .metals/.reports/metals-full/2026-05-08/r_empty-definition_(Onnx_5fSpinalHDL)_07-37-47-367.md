error id: file://<WORKSPACE>/sw/scala/main/scala/runtime/dispatch/AcceleratorDispatcher.scala:Accelerator/AcceleratorSimInterface.
file://<WORKSPACE>/sw/scala/main/scala/runtime/dispatch/AcceleratorDispatcher.scala
empty definition using pc, found symbol in pc: Accelerator/AcceleratorSimInterface.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -Accelerator.AcceleratorSimInterface.
	 -Accelerator.AcceleratorSimInterface#
	 -Accelerator.AcceleratorSimInterface().
	 -Util.AcceleratorSimInterface.
	 -Util.AcceleratorSimInterface#
	 -Util.AcceleratorSimInterface().
	 -runtime/engine/AcceleratorSimInterface.
	 -runtime/engine/AcceleratorSimInterface#
	 -runtime/engine/AcceleratorSimInterface().
	 -runtime/dispatch/ops/AcceleratorSimInterface.
	 -runtime/dispatch/ops/AcceleratorSimInterface#
	 -runtime/dispatch/ops/AcceleratorSimInterface().
	 -AcceleratorSimInterface.
	 -AcceleratorSimInterface#
	 -AcceleratorSimInterface().
	 -scala/Predef.AcceleratorSimInterface.
	 -scala/Predef.AcceleratorSimInterface#
	 -scala/Predef.AcceleratorSimInterface().
offset: 69
uri: file://<WORKSPACE>/sw/scala/main/scala/runtime/dispatch/AcceleratorDispatcher.scala
text:
```scala
