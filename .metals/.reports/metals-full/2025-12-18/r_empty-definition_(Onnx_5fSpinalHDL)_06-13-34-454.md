error id: file://<WORKSPACE>/hw/spinal/WrapForFPGA/WrapForFPGA.scala:WrapForFPGA/Inst128_Wrapper#`<init>`().(use64BitBus)
file://<WORKSPACE>/hw/spinal/WrapForFPGA/WrapForFPGA.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol WrapForFPGA/Inst128_Wrapper#use64BitBus.
empty definition using fallback
non-local guesses:

offset: 3451
uri: file://<WORKSPACE>/hw/spinal/WrapForFPGA/WrapForFPGA.scala
text:
```scala
package WrapForFPGA
...
case class WrapForFPGA(fpgaCfg: FPGACfg) extends Component {
  ...
  val instBridge = new Inst128_Wrapper(use64@@BitBus = false)
