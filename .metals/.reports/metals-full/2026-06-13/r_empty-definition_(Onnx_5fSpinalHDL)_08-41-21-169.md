error id: file://<WORKSPACE>/hw/spinal/Accelerator/Accelerator.scala:memoryReadPortB
file://<WORKSPACE>/hw/spinal/Accelerator/Accelerator.scala
empty definition using pc, found symbol in pc: memoryReadPortB
semanticdb not found
empty definition using fallback
non-local guesses:
	 -Tiling.slicer.io.memoryReadPortB.
	 -Tiling.slicer.io.memoryReadPortB#
	 -Tiling.slicer.io.memoryReadPortB().
	 -DataPump.slicer.io.memoryReadPortB.
	 -DataPump.slicer.io.memoryReadPortB#
	 -DataPump.slicer.io.memoryReadPortB().
	 -MatrixComputeUnit.SystolicArray2D.slicer.io.memoryReadPortB.
	 -MatrixComputeUnit.SystolicArray2D.slicer.io.memoryReadPortB#
	 -MatrixComputeUnit.SystolicArray2D.slicer.io.memoryReadPortB().
	 -Activation.slicer.io.memoryReadPortB.
	 -Activation.slicer.io.memoryReadPortB#
	 -Activation.slicer.io.memoryReadPortB().
	 -ExponentialFunction.slicer.io.memoryReadPortB.
	 -ExponentialFunction.slicer.io.memoryReadPortB#
	 -ExponentialFunction.slicer.io.memoryReadPortB().
	 -LogarithmFunction.slicer.io.memoryReadPortB.
	 -LogarithmFunction.slicer.io.memoryReadPortB#
	 -LogarithmFunction.slicer.io.memoryReadPortB().
	 -ReLUFunction.slicer.io.memoryReadPortB.
	 -ReLUFunction.slicer.io.memoryReadPortB#
	 -ReLUFunction.slicer.io.memoryReadPortB().
	 -SoftplusFunction.slicer.io.memoryReadPortB.
	 -SoftplusFunction.slicer.io.memoryReadPortB#
	 -SoftplusFunction.slicer.io.memoryReadPortB().
	 -spinal/core/slicer/io/memoryReadPortB.
	 -spinal/core/slicer/io/memoryReadPortB#
	 -spinal/core/slicer/io/memoryReadPortB().
	 -scala/math/slicer/io/memoryReadPortB.
	 -scala/math/slicer/io/memoryReadPortB#
	 -scala/math/slicer/io/memoryReadPortB().
	 -slicer/io/memoryReadPortB.
	 -slicer/io/memoryReadPortB#
	 -slicer/io/memoryReadPortB().
	 -scala/Predef.slicer.io.memoryReadPortB.
	 -scala/Predef.slicer.io.memoryReadPortB#
	 -scala/Predef.slicer.io.memoryReadPortB().
offset: 4278
uri: file://<WORKSPACE>/hw/spinal/Accelerator/Accelerator.scala
text:
```scala
package Accelerator
...
case class Accelerator(acceleratorCfg: AcceleratorCfg) extends Component {
  ...
  Seq(
    ...
    (slicer.io.memoryReadPort@@B, sdpramB.io.read)
