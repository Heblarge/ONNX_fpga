error id: file://<WORKSPACE>/sw/java/main/java/org/forwarder/Model.java:org/onnx4j/Model#
file://<WORKSPACE>/sw/java/main/java/org/forwarder/Model.java
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol org/onnx4j/Model#
empty definition using fallback
non-local guesses:

offset: 520
uri: file://<WORKSPACE>/sw/java/main/java/org/forwarder/Model.java
text:
```scala
