error id: file://<WORKSPACE>/hw/spinal/MatrixCacheInterface/InputMatrixCache.scala:DataPump/MemoryReadPort_TypeDef.
file://<WORKSPACE>/hw/spinal/MatrixCacheInterface/InputMatrixCache.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol DataPump/MemoryReadPort_TypeDef#
empty definition using fallback
non-local guesses:

offset: 2806
uri: file://<WORKSPACE>/hw/spinal/MatrixCacheInterface/InputMatrixCache.scala
text:
```scala
