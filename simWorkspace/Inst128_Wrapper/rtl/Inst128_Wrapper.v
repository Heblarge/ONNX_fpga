...
module Inst128_Wrapper (
  ...
  input  wire [31:0]   io_s_axi_w_payload_data,
  input  wire [3:0]    io_s_axi_w_payload_strb,
  ...
  output wire [31:0]   io_s_axi_r_payload_data,
  ...
  wire       [31:0]   core_io_s_axi_r_payload_data;
  ...
  Axi4LiteToStream core (
    ...
    .io_s_axi_w_payload_data    (io_s_axi_w_payload_data[31:0]        ), //i
    .io_s_axi_w_payload_strb    (io_s_axi_w_payload_strb[3:0]         ), //i
    ...
    .io_s_axi_r_payload_data    (core_io_s_axi_r_payload_data[31:0]   ), //o
...
module Axi4LiteToStream (
  ...
  assign busCtrl_readAddressMasked = (busCtrl_readDataStage_payload_addr & (~ 12'h003));
  assign busCtrl_writeAddressMasked = (io_s_axi_aw_payload_addr & (~ 12'h003));
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      case(busCtrl_writeAddressMasked)
        ...
        12'h004 : begin
          if(busCtrl_writeOccur) begin
            shadowReg_SLICE1 <= io_s_axi_w_payload_data[31 : 0];
          end
        end
        12'h008 : begin
          if(busCtrl_writeOccur) begin
        ...
        12'h00c : begin
          if(busCtrl_writeOccur) begin
            shadowReg_SLICE3 <= io_s_axi_w_payload_data[31 : 0];
          end
        end
        default : begin
        end
