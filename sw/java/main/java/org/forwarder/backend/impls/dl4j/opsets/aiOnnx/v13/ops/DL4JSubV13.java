...
public class DL4JSubV13 extends DL4JSubV7 implements SubV13 {

    @Override
    public OperatorOutputs<INDArray> forward(Node node, Inputs inputs) {
        SubInputsV13<INDArray> castedOperatorInputs = new SubInputsV13<INDArray>(node, inputs);
        INDArray a = castedOperatorInputs.getA();
        INDArray b = castedOperatorInputs.getB();
        return new SubOutputV13<INDArray>(this.sub(a, b));
    }
