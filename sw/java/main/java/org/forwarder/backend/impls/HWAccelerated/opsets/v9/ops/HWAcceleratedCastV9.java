...
import org.forwarder.backend.impls.HWAccelerated.opsets.v6.ops.HWAcceleratedCastV6;
...
public class HWAcceleratedCastV9 extends HWAcceleratedCastV6 implements CastV9 {
	...
	protected INDArray cast(INDArray t1, org.nd4j.linalg.api.buffer.DataType to) {
		if (t1.dataType().equals(org.nd4j.linalg.api.buffer.DataType.UTF8) && to.isNumerical())
			throw new UnsupportedOperationException(
					String.format("Can not convert datatype from \"%s\"(HWAccelerated) to \"%s\"(ONN4J)", t1.dataType(), to));
