...
public class TensorException extends Onnx4jException {

	private static final long serialVersionUID = -9110594428291367746L;
	
	private static final String ERR_CODE_PREFIX = "TE";

	private static int ERR_CODE_BASE = 3000;
	...
	public TensorException(NodeExceptionEnums exceptionEnum) {
		this(exceptionEnum, new Object[] {});
	}

	public TensorException(NodeExceptionEnums exceptionEnum, Object... args) {
