...
public interface SubExpV13 extends AiOnnxOperatorV13{
    String OP_TYPE = "SubExp";
    ...
    class SubExpInputsV13<T_TENSOR> extends OperatorInputs<T_TENSOR> {
        ...
        public SubExpInputsV13(Node node, Inputs inputs) {
            super(node, inputs);
    ...
    class SubExpOutputV13<T_Tense> extends SingleOperatorOutputs{
        public SubExpOutputV13(T_Tense output) {
            super(output);
        }
