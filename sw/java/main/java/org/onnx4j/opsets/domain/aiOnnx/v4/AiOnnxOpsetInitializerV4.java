 ...
 */
package org.onnx4j.opsets.domain.aiOnnx.v4;
 ...
 *
 */
public interface AiOnnxOpsetInitializerV4 extends AiOnnxOpsetInitializerV3 {
	
	public abstract ConcatV4 getConcatV4();

	//@Override
	public default Map<String, Operator> initializeOperators() {
		Map<String, Operator> operators = AiOnnxOpsetInitializerV3.super.initializeOperators();
		// 20191119
