...
public interface GemmV11 extends AiOnnxOperatorV11 {
    ...
    class GeMMInputsV11<T_TENSOR> extends OperatorInputs<T_TENSOR> {
        ...
        public GeMMInputsV11(Node node, Inputs inputs) {
            super(node, inputs);
    ...
    class GeMMOutputV11<T_TENSOR> extends SingleOperatorOutputs<T_TENSOR> {
        public GeMMOutputV11(T_TENSOR output) {
            super(output);
        }
