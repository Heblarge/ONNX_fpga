 ...
 *      ONNX.Operators.md</a>
 */
public interface AveragePoolV1 extends AiOnnxOperatorV1 {
	 ...
	 */
	class AveragePoolInputsV1<T_TENSOR> extends OperatorInputs<T_TENSOR> {
		...
		protected AttributeField<String> autoPadField;

		protected AttributeField<List<Long>> kernelShapeField;

		protected AttributeField<List<Long>> padsField;

		protected AttributeField<List<Long>> stridesField;

		public AveragePoolInputsV1(Node node, Inputs inputs) {
			super(node, inputs);
	 ...
	 *            The backend tensor object.
	 */
	class AveragePoolOutputV1<T_TENSOR> extends SingleOperatorOutputs<T_TENSOR> {

		public AveragePoolOutputV1(T_TENSOR output) {
			super(output);
		}
