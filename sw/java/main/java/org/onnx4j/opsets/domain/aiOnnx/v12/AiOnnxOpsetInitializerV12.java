 ...
 */
package org.onnx4j.opsets.domain.aiOnnx.v12;
 ...
 *
 */
public interface AiOnnxOpsetInitializerV12 extends AiOnnxOpsetInitializerV11 {

	public abstract ReduceMaxV12 getReduceMaxV12();

	@Override
	public default Map<String, Operator> initializeOperators() {
		Map<String, Operator> operators = AiOnnxOpsetInitializerV11.super.initializeOperators();
		// 20200113
