 ...
 *      ONNX.Operators.md</a>
 */
public interface AveragePoolV7 extends AveragePoolV1, AiOnnxOperatorV7  {
	 ...
	 */
	class AveragePoolInputsV7<T_TENSOR> extends AveragePoolInputsV1<T_TENSOR> {
		 ...
		 */
		private Field<Long> countIncludePadField;

		public AveragePoolInputsV7(Node node, Inputs inputs) {
			super(node, inputs);

			//
			// int (default is 0)
			//
			countIncludePadField = new AttributeField<Long>(super.attrs, ATTR_COUNT_INCLUDE_PAD, IntAttribute.class, 0L,
					false);
		}

		public Long getCountIncludePad() {
			return countIncludePadField.getData();
		}
	 ...
	 *            The backend tensor object.
	 */
	class AveragePoolOutputV7<T_TENSOR> extends AveragePoolOutputV1<T_TENSOR> {

		public AveragePoolOutputV7(T_TENSOR output) {
			super(output);
		}
