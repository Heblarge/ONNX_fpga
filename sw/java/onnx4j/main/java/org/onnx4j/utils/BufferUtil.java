...
import static org.onnx4j.utils.UnsafeAccess.UNSAFE;
...
public final class BufferUtil {
	 ...
	 * {@link IndexOutOfBoundsException} if exceeded.
	 *
	 * @param buffer
	 *            to be checked.
	 * @param index
	 *            at which the access will begin.
	 * @param length
	...
	/**
	 * Get the array from a read-only {@link ByteBuffer} similar to
	 * {@link ByteBuffer#array()}.
	 *
	 * @param buffer
	 *            that wraps the underlying array.
	...
	/**
	 * Get the array offset from a read-only {@link ByteBuffer} similar to
