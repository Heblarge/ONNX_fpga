 ...
 */
package org.onnx4j.opsets.domain.aiOnnx.v5;
 ...
 *
 */
public interface AiOnnxOpsetInitializerV5 extends AiOnnxOpsetInitializerV4 {

	public abstract ReshapeV5 getReshapeV5();

	//@Override
	public default Map<String, Operator> initializeOperators() {
		Map<String, Operator> operators = AiOnnxOpsetInitializerV4.super.initializeOperators();
		// 20191120
