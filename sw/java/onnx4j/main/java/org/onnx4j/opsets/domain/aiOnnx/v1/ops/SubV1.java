 ...
 *      Operators.md</a>
 */
public interface SubV1 extends AiOnnxOperatorV1 {
	 ...
	 */
	// public abstract T_TENSOR sub(T_TENSOR a, T_TENSOR b, Long axis, Long
	// broadcast, List<Long> consumedInputs);
	...
	class SubInputsV1<T_TENSOR> extends OperatorInputs<T_TENSOR> {
		...
		public SubInputsV1(Node node, Inputs inputs) {
			super(node, inputs);
		}
	 ...
	 */
	class SubOutputV1<T_TENSOR> extends SingleOperatorOutputs<T_TENSOR> {

		public SubOutputV1(T_TENSOR output) {
			super(output);
		}
