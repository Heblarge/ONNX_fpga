 ...
 *      Operators.md</a>
 */
public interface AddV1 extends AiOnnxOperatorV1 {
	...
	class AddInputsV1<T_TENSOR> extends OperatorInputs<T_TENSOR> {
		...
		public AddInputsV1(Node node, Inputs inputs) {
			super(node, inputs);
		}
	 ...
	 */
	class AddOutputV1<T_TENSOR> extends SingleOperatorOutputs<T_TENSOR> {

		public AddOutputV1(T_TENSOR output) {
			super(output);
		}
