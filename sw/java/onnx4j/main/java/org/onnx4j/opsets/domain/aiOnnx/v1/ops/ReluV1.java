 ...
 *      Operators.md</a>
 */
public interface ReluV1 extends AiOnnxOperatorV1 {
	 ...
	 */
	class ReluInputsV1<T_TENSOR> extends OperatorInputs<T_TENSOR> {
		...
		public ReluInputsV1(Node node, Inputs inputs) {
			super(node, inputs);
	 ...
	 *            The backend tensor object.
	 */
	class ReluOutputV1<T_TENSOR> extends SingleOperatorOutputs<T_TENSOR> {

		public ReluOutputV1(T_TENSOR output) {
			super(output);
		}
