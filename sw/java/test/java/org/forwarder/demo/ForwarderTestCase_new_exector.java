...
public abstract class ForwarderTestCase_new_exector extends TestCase {

	private static final int TENSOR_MAX_OUTPUT_LEN = 1000;

	private static Logger logger = LoggerFactory.getLogger(ForwarderTestCase_new_exector.class);
	 ...
	 */
	public ForwarderTestCase_new_exector(String testName) {
		super(testName);
	}
	...
	protected void testModel(Map<String, String> tensorPairPaths, String modelPath, String inputName, String outputName,
		...
		// 从Resource获取模型文件地址
		String absoluteModelPath = URLDecoder.decode(ForwarderTestCase_new_exector.class.getResource(modelPath).getFile(), "utf-8");
