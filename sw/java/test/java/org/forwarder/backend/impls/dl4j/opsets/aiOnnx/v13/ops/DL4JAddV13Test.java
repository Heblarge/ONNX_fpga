 ...
 *
 */
public class DL4JAddV13Test extends DL4JTestCase {
    ...
    public void test1() throws Exception {
        try (INDArray excepted = Nd4j.create(256, 256, 3);
            ...
            this.testAdd(excepted, a, b);
            this.testAdd(excepted, b, a);
        }
    }
    ...
    private void testAdd(INDArray excepted, INDArray a, INDArray b) throws Exception {
        try (DL4JSession session = new DL4JSession(null)) {
            DL4JAddV13 operator = new DL4JAddV13();
            INDArray y = operator.add(a, b);
