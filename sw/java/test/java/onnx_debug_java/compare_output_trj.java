...
public class compare_output_trj {
    ...
    public static void main(String[] args) throws IOException {
        File pbFile = new File("/home/user/Workspace/livehps_1/sw/java/test/java/onnx_debug_java/pb_output/output_trj.pb");
        File binFile = new File("/home/user/Workspace/livehps_1/sw/java/test/java/onnx_debug_java/onnx_output/trj.bin");
        float tolerance = 1e-4f;

        String outputDirectory = "/home/user/Workspace/livehps_1/sw/java/test/java/onnx_debug_java/";

        File pbValuesFile = new File(outputDirectory, "pb_trj_values.txt");
        File binValuesFile = new File(outputDirectory, "bin_trj_values.txt");
        File errorDetailsFile = new File(outputDirectory, "error_trj_details.txt");
