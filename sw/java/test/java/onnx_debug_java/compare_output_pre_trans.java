...
public class compare_output_pre_trans {
    ...
    public static void main(String[] args) throws IOException {
        File pbFile = new File("/home/user/Workspace/livehps_1/sw/java/test/java/onnx_debug_java/pb_output/output_pre_tran.pb");
        File binFile = new File("/home/user/Workspace/livehps_1/sw/java/test/java/onnx_debug_java/onnx_output/pre_trans.bin");
        float tolerance = 1e-3f;

        String outputDirectory = "/home/user/Workspace/livehps_1/sw/java/test/java/onnx_debug_java/";

        File pbValuesFile = new File(outputDirectory, "pb_pre_trans_values.txt");
        File binValuesFile = new File(outputDirectory, "bin_pre_trans_values.txt");
        File errorDetailsFile = new File(outputDirectory, "error_pre_trans_details.txt");
