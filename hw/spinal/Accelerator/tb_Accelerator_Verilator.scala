...
/**
 * AcceleratorTbVerilator — Verilator version of AcceleratorTb.
 *
 * Uses the same test logic, config, and assertions as AcceleratorTb
 * but compiles with Verilator instead of VCS for much faster simulation.
 *
 * Run via:
 *   sbt 'runMain Accelerator.AcceleratorTbVerilator'
 */
object AcceleratorTbVerilator extends App {
  val period = 10
  ...
  val path = s"simWorkspace/AcceleratorTbVerilator"
  import java.io.File
