...
/**
 * AcceleratorSimInterfaceVerilator — Verilator version of AcceleratorSimInterface.
 *
 * Same accelerator config (elementWidth=32, systolicArraySideNum=16) and
 * simulation logic as VCS, but compiles with Verilator for faster execution.
 */
object AcceleratorSimInterfaceVerilator {
  val period = 10
  ...
  lazy val compiled = SimConfig  // No wave dump for speed
    .allOptimisation
    .withConfig(
      SpinalConfig(
